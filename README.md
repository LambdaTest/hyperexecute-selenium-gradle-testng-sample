...
<p align="center">
  ...
  <a href="https://www.testmuai.com/hyperexecute"><img src="https://img.shields.io/badge/HyperExecute-Selenium%20Gradle%20TestNG-orange.svg?style=for-the-badge&labelColor=000000" alt="HyperExecute Selenium Gradle TestNG"></a>
...
With TestMu AI (Formerly LambdaTest), you can run Selenium Gradle TestNG tests across real browsers and operating systems at scale. This sample shows how to configure Selenium Gradle TestNG tests to run on the TestMu AI HyperExecute cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-selenium-gradle-testng-sample.git
cd hyperexecute-selenium-gradle-testng-sample
```
